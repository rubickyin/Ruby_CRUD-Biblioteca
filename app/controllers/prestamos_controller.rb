class PrestamosController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to prestamos_path, status: :see_other, notice: "Prestamo was successfully destroyed." }
  ...
  private
    ...
    def prestamo_params
      params.require(:prestamo).permit(:usuario_id, :libro_id, :fecha_prestamo, :fecha_devolucion, :estado)
    end
end
