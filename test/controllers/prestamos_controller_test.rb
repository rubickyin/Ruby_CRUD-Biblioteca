...
class PrestamosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prestamo" do
    assert_difference("Prestamo.count") do
      post prestamos_url, params: { prestamo: { estado: @prestamo.estado, fecha_devolucion: @prestamo.fecha_devolucion, fecha_prestamo: @prestamo.fecha_prestamo, libro_id: @prestamo.libro_id, usuario_id: @prestamo.usuario_id } }
    end
  ...
  test "should update prestamo" do
    patch prestamo_url(@prestamo), params: { prestamo: { estado: @prestamo.estado, fecha_devolucion: @prestamo.fecha_devolucion, fecha_prestamo: @prestamo.fecha_prestamo, libro_id: @prestamo.libro_id, usuario_id: @prestamo.usuario_id } }
