...
class AutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create autor" do
    assert_difference("Autor.count") do
      post autors_url, params: { autor: { biografia: @autor.biografia, fecha_fallecimiento: @autor.fecha_fallecimiento, fecha_nacimiento: @autor.fecha_nacimiento, nombre: @autor.nombre, pais: @autor.pais } }
    end
  ...
  test "should update autor" do
    patch autor_url(@autor), params: { autor: { biografia: @autor.biografia, fecha_fallecimiento: @autor.fecha_fallecimiento, fecha_nacimiento: @autor.fecha_nacimiento, nombre: @autor.nombre, pais: @autor.pais } }
