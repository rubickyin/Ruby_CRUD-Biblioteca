...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference("Categorium.count") do
      post categoria_url, params: { categorium: { descripcion: @categorium.descripcion, estado: @categorium.estado, fecha_creacion: @categorium.fecha_creacion, nivel: @categorium.nivel, nombre: @categorium.nombre } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { descripcion: @categorium.descripcion, estado: @categorium.estado, fecha_creacion: @categorium.fecha_creacion, nivel: @categorium.nivel, nombre: @categorium.nombre } }
